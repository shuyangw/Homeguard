@echo off
REM Higher Capital with Lower Fees (SWEEP MODE)
REM Simulates institutional trading conditions across DOW30
...
echo ========================================
echo Institutional Settings Backtest (SWEEP)
echo Strategy: Moving Average Crossover
echo Capital: $500,000
echo Fees: 0.05%% (institutional rate)
...
python "%~dp0..\..\src\backtest_runner.py" ^
  ...
  --capital 500000 ^
  --fees 0 ^
  --run-name "05_institutional_settings_sweep" ^
