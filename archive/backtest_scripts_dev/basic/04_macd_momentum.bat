@echo off
REM MACD Momentum Strategy (SWEEP MODE)
REM Tests classic MACD crossover across FAANG stocks
...
echo ========================================
echo MACD Momentum Backtest (SWEEP)
echo Strategy: MACD Momentum
...
python "%~dp0..\..\src\backtest_runner.py" ^
  ...
  --fees %BACKTEST_FEES% ^
  --run-name "04_macd_momentum_sweep" ^
