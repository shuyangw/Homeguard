...
V28, V31, and V26-robust all have FIXED, a-priori parameters:
...
- V26-robust: lambda=1.0, winsor 0.01/0.99, horizons 21d/5d (canonical MAD z-score)
...
Per-window Sharpe for all 7 family variants. V11 is the benchmark.

| Window | n | V11 | V28 | V31 | V02+V05 | V26 | V33-core | V26-robust | V28>V11 | V31>V11 | V26r>V11 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :---: | :---: | :---: |
| 2019 | 252 | 1.483 | 0.946 | 1.535 | 1.377 | 1.056 | 1.009 | 1.086 | N | Y | N |
| 2020 | 253 | 0.838 | 0.825 | 0.813 | 1.083 | 1.181 | 0.871 | 0.967 | N | N | Y |
| 2021 | 252 | 1.181 | 0.916 | 1.528 | 0.972 | 0.740 | 0.797 | 0.731 | N | Y | N |
| 2022 | 251 | -0.266 | -0.496 | -0.745 | -0.120 | -0.589 | -1.543 | -0.461 | N | N | N |
| 2023 | 250 | 1.170 | 1.485 | 1.864 | 1.403 | 1.577 | 1.355 | 1.621 | Y | Y | Y |
| 2024 | 252 | 0.829 | 1.020 | 1.295 | 1.192 | 0.866 | 1.494 | 0.959 | Y | Y | Y |
| 2025+ | 343 | 0.527 | 1.685 | 1.341 | 0.248 | 0.458 | 0.536 | 1.029 | Y | Y | Y |
...
### V26-robust OOS Summary

| Metric | Value |
|---|---:|
| Win rate vs V11 | 57% (4/7) |
| Worst OOS Sharpe | -0.461 |
| Best OOS Sharpe | 1.621 |
| Sharpe dispersion (std) | 0.638 |
| Pooled OOS Sharpe | 0.742 |

## Section 3: Selection Rank Stability

Rank-stability of V28, V31, and V26-robust across OOS windows (1 = best of 7 variants).
Ties the PBO finding to temporal evidence: does the family ranking
agree across time periods?

### Per-Window Family Ranking

| Window | Rank(V28) | Rank(V31) | Rank(V26-robust) | Rank(V02+V05) | Rank(V26) | Rank(V11) | Rank(V33-core) |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 2019 | 7 | 1 | 4 | 3 | 5 | 2 | 6 |
| 2020 | 6 | 7 | 3 | 2 | 1 | 5 | 4 |
| 2021 | 4 | 1 | 7 | 3 | 6 | 2 | 5 |
...
| V28 | 4.3 | 4.0 | 1 | 7 | 14% |
| V31 | 2.9 | 2.0 | 1 | 7 | 71% |
| V26-robust | 3.9 | 3.0 | 2 | 7 | 14% |

### Connection to PBO / Selection Bias

V28/V31 PBO was 0.503 at the family gate (IS-best underperforms OOS median
in majority of CSCV folds). V26-robust is a separate a-priori candidate with
its own selection trial; its rank stability here is purely informational.
If V26-robust ranks top-tier consistently, its OOS edge is time-consistent,
not period-concentrated.

## Section 4: Slice vs Direct Run_Variant Verification

Verification skipped (--skip-verify flag set).

## Section 5: Cost Gate at 7.5 bps (1.5x Cost Sensitivity)

Per-window Sharpe at 7.5 bps for V28, V31, V26-robust, and V11.

| Window | V11 (7.5bps) | V28 (7.5bps) | V31 (7.5bps) | V26-robust (7.5bps) | V28>V11 | V31>V11 | V26r>V11 |
|---|---:|---:|---:|---:|:---:|:---:|:---:|
| 2019 | 1.391 | 0.842 | 1.421 | 0.924 | N | Y | N |
| 2020 | 0.767 | 0.785 | 0.763 | 0.909 | Y | N | Y |
| 2021 | 1.095 | 0.853 | 1.431 | 0.604 | N | Y | N |
| 2022 | -0.331 | -0.550 | -0.797 | -0.557 | N | N | N |
| 2023 | 1.045 | 1.442 | 1.793 | 1.490 | Y | Y | Y |
| 2024 | 0.771 | 0.981 | 1.190 | 0.825 | Y | Y | Y |
| 2025+ | 0.419 | 1.650 | 1.277 | 0.935 | Y | Y | Y |
...
| Selection rank stability (mean) | 4.29 | <= 2 preferred | INFO |
| Sharpe dispersion (std) | 0.699 | < 0.5 preferred | INFO |

**V28 RATIONALE**: OOS performance insufficient. Full-window edge was concentrated in specific periods; walk-forward confirms REJECT. Honest prior: V28 (+0.283 vs V11) and V31 (+0.241 vs V11) both rejected on BEAR years (2020/2022). V26-robust has a smaller edge (+0.107) and is susceptible to the same failure mode.
...
| Selection rank stability (mean) | 2.86 | <= 2 preferred | INFO |
| Sharpe dispersion (std) | 0.870 | < 0.5 preferred | INFO |

**V31 RATIONALE**: OOS performance insufficient. Full-window edge was concentrated in specific periods; walk-forward confirms REJECT. Honest prior: V28 (+0.283 vs V11) and V31 (+0.241 vs V11) both rejected on BEAR years (2020/2022). V26-robust has a smaller edge (+0.107) and is susceptible to the same failure mode.
...
| Selection rank stability (mean) | 3.86 | <= 2 preferred | INFO |
| Sharpe dispersion (std) | 0.638 | < 0.5 preferred | INFO |

**V26-robust RATIONALE**: OOS performance insufficient. Full-window edge was concentrated in specific periods; walk-forward confirms REJECT. Honest prior: V28 (+0.283 vs V11) and V31 (+0.241 vs V11) both rejected on BEAR years (2020/2022). V26-robust has a smaller edge (+0.107) and is susceptible to the same failure mode.
