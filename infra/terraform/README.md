...
**Location**: `infra/ec2/` (repository root)
...
3. ✅ Run health check: `infra\ec2\daily_health_check.bat` (or `.sh`)
4. ✅ Verify bot is running: `infra\ec2\check_bot.bat` (or `.sh`)
5. ✅ Monitor first trading window: `infra\ec2\view_logs.bat` (or `.sh`)
