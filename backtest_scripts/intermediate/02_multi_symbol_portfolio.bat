@echo off
REM Multi-Symbol Sweep Backtest (SWEEP MODE)
REM Tests MA strategy across Tech Giants independently
...
echo ========================================
echo Multi-Symbol Sweep Backtest
...
python "%~dp0..\..\src\backtest_runner.py" ^
  ...
  --capital 100000 ^
  --fees 0 ^
  --run-name "02_multi_symbol_sweep" ^
