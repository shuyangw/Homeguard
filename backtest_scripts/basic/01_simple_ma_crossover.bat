@echo off
REM Simple Moving Average Crossover Backtest (SWEEP MODE)
REM Tests the classic 20/50 MA crossover across FAANG stocks
...
echo ========================================
echo Simple MA Crossover Backtest (SWEEP)
...
python "%~dp0..\..\src\backtest_runner.py" ^
  ...
  --fees %BACKTEST_FEES% ^
  --run-name "01_simple_ma_crossover_sweep" ^
