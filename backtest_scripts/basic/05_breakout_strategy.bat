@echo off
REM Price Breakout Strategy (SWEEP MODE)
REM Tests 20-period high breakout across FAANG stocks
...
echo ========================================
echo Breakout Strategy Backtest (SWEEP)
...
python "%~dp0..\..\src\backtest_runner.py" ^
  ...
  --fees %BACKTEST_FEES% ^
  --run-name "05_breakout_strategy_sweep" ^
