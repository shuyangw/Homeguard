@echo off
REM Large Portfolio Sweep (SWEEP MODE)
REM Tests strategy across TECH_GIANTS independently
...
python "%~dp0..\..\src\backtest_runner.py" ^
  ...
  --capital 500000 ^
  --fees 0 ^
  --run-name "01_large_portfolio_sweep" ^
