"""
Optimization script for MovingAverageCrossover strategy.

Tests MA crossover on large cap stocks with expanded parameter ranges
to fix the negative Sharpe issue found in previous tests.
"""
...
def optimize_moving_average_crossover():
    """Optimize MovingAverageCrossover strategy with expanded parameters."""
    logger.blank()
    logger.separator()
    logger.header("MOVING AVERAGE CROSSOVER OPTIMIZATION (EXPANDED)")
    logger.separator()
    logger.blank()

    # Symbols: Large cap stocks that tend to trend
    symbols = ['AAPL', 'MSFT', 'TSLA']

    # Parameter grid - EXPANDED from previous narrow ranges
    param_grid = {
...
if __name__ == '__main__':
    try:
        results = optimize_moving_average_crossover()
